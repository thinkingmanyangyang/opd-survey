hapo | Heterogeneous Adaptive Policy Optimization (HAPO) | 北京大学 / 上海 AI Lab / 北航（共一 Zheng Liu、Mengjie Liu；通讯 Wentao Zhang、Lijun Wu）| arXiv 2509.16591v2, 2026-04-29 · 预印本 | 主题线 L3/L6（token 异质性驱动 RLVR；token 信用）·相关性 中（token 级关键步识别与「选路/关键步」概念相关，但本身非蒸馏/无 teacher）
